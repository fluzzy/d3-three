...
[![bundle size](https://img.shields.io/badge/gzip-~13.6%20KB-blue.svg)](https://bundlephobia.com/package/d3-three)
...
- **Tiny** — ~13.6 KB (gzip), tree-shakeable, ESM + CJS.
...
- Bundle: **~13.6 KB** (gzip), `sideEffects: false`, tree-shakeable.
